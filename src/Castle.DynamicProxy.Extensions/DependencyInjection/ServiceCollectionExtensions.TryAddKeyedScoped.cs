// -----------------------------------------------------------------------
// <copyright file="ServiceCollectionExtensions.TryAddKeyedScoped.cs" company="Karma, LLC">
...
namespace Microsoft.Extensions.DependencyInjection
{
  ...
  {
    /// <summary>
    /// Attempts to add a keyed scoped service of the specified type to the dependency injection container with the
    /// provided interceptors if it has not already been registered.
    /// </summary>
    /// <remarks>
    /// Scoped services are created once per client request (scope). If the service type with the specified key has
    ...
    /// <returns>The <see cref="IServiceCollection"/> instance with the intercepted keyed scoped service registration added if it was
    /// not already present.</returns>
    public static IServiceCollection TryAddKeyedInterceptedScoped(
      this IServiceCollection services,
      [DynamicallyAccessedMembers(DynamicallyAccessedMemberTypes.PublicConstructors)] Type serviceType,
      object? serviceKey,
      params IInterceptor[] interceptors) =>
      services.TryAddKeyedIntercepted(serviceType, serviceKey, ServiceLifetime.Scoped, interceptors);
    ...
    /// order specified. If the service type with the specified key is already registered, no changes are made.
    /// </remarks>
    /// <param name="services">The <see cref="IServiceCollection"/> to which the service will be added.</param>
    /// <param name="serviceType">The type of the service to register. Must have a public constructor.</param>
    /// <param name="serviceKey">The key that uniquely identifies the keyed service registration. Pass null to use null as the key.
    ...
    public static IServiceCollection TryAddKeyedInterceptedScoped(
      ...
      services.TryAddKeyedIntercepted(serviceType, serviceKey, ServiceLifetime.Scoped, interceptorTypes);

    /// <summary>
    /// Attempts to add a keyed scoped service of the specified type and implementation to the dependency injection
    ...
    public static IServiceCollection TryAddKeyedInterceptedScoped(
      ...
      params IInterceptor[] interceptors) =>
      services.TryAddKeyedIntercepted(serviceType, serviceKey, implementationType, ServiceLifetime.Scoped, interceptors);
    ...
    public static IServiceCollection TryAddKeyedInterceptedScoped(
      ...
      [DynamicallyAccessedMembers(DynamicallyAccessedMemberTypes.PublicConstructors)] Type implementationType,
      [DynamicallyAccessedMembers(DynamicallyAccessedMemberTypes.PublicConstructors)] params Type[] interceptorTypes) =>
      services.TryAddKeyedIntercepted(serviceType, serviceKey, implementationType, ServiceLifetime.Scoped, interceptorTypes);

    /// <summary>
    /// Attempts to add a keyed scoped service of the specified type to the dependency injection container using a
    ...
    /// resulting instance is wrapped with the specified interceptors. If the service type with the specified key is
    /// already registered, no changes are made.
    /// </remarks>
    /// <param name="services">The <see cref="IServiceCollection"/> to which the service will be added.</param>
    ...
    public static IServiceCollection TryAddKeyedInterceptedScoped(
      ...
      params IInterceptor[] interceptors) =>
      services.TryAddKeyedIntercepted(serviceType, serviceKey, implementationFactory, ServiceLifetime.Scoped, interceptors);
    ...
    /// per scope. If the service type with the specified key is already registered, no changes are made.
    /// </remarks>
    /// <param name="services">The <see cref="IServiceCollection"/> to which the service will be added.</param>
    /// <param name="serviceType">The type of the service to register.</param>
    /// <param name="serviceKey">The key that uniquely identifies the keyed service registration. Pass null to use null as the key.
    ...
    public static IServiceCollection TryAddKeyedInterceptedScoped(
      ...
      Func<IServiceProvider, object?, object> implementationFactory,
      [DynamicallyAccessedMembers(DynamicallyAccessedMemberTypes.PublicConstructors)] params Type[] interceptorTypes) =>
      services.TryAddKeyedIntercepted(serviceType, serviceKey, implementationFactory, ServiceLifetime.Scoped, interceptorTypes);

    /// <summary>
    /// Attempts to add a keyed scoped service of type <typeparamref name="TService"/> to the dependency injection
    ...
    /// <returns>The <see cref="IServiceCollection"/> instance with the intercepted keyed scoped service registration added if it was
    /// not already present.</returns>
    public static IServiceCollection TryAddKeyedInterceptedScoped<[DynamicallyAccessedMembers(DynamicallyAccessedMemberTypes.PublicConstructors)] TService>(
      this IServiceCollection services,
      object? serviceKey,
      Func<IServiceProvider, object?, TService> implementationFactory,
      params IInterceptor[] interceptors)
      where TService : class =>
      services.TryAddKeyedIntercepted(serviceKey, implementationFactory, ServiceLifetime.Scoped, interceptors);
    ...
    public static IServiceCollection TryAddKeyedInterceptedScoped<[DynamicallyAccessedMembers(DynamicallyAccessedMemberTypes.PublicConstructors)] TService>(
      ...
      [DynamicallyAccessedMembers(DynamicallyAccessedMemberTypes.PublicConstructors)] params Type[] interceptorTypes)
      where TService : class =>
      services.TryAddKeyedIntercepted(serviceKey, implementationFactory, ServiceLifetime.Scoped, interceptorTypes);
    ...
    /// container. If the service type with the specified key is already registered, no changes are made.
    /// </remarks>
    /// <typeparam name="TService">The type of the service to register. Must be a reference type with a public constructor.</typeparam>
    ...
    /// <returns>The <see cref="IServiceCollection"/> instance with the intercepted keyed scoped service registration added if it was
    /// not already present.</returns>
    public static IServiceCollection TryAddKeyedInterceptedScoped<[DynamicallyAccessedMembers(DynamicallyAccessedMemberTypes.PublicConstructors)] TService, [DynamicallyAccessedMembers(DynamicallyAccessedMemberTypes.PublicConstructors)] TInterceptor>(
      this IServiceCollection services,
      object? serviceKey,
      Func<IServiceProvider, object?, TService> implementationFactory)
      where TService : class
      where TInterceptor : IInterceptor =>
      services.TryAddKeyedIntercepted<TService, TInterceptor>(serviceKey, implementationFactory, ServiceLifetime.Scoped);
    ...
    /// authorization. If the service type with the specified key is already registered, no changes are made.
    /// </remarks>
    /// <typeparam name="TService">The type of the service to register. Must be a reference type with a public constructor.</typeparam>
    /// <param name="services">The <see cref="IServiceCollection"/> to which the service will be added.</param>
    /// <param name="serviceKey">The key that uniquely identifies the keyed service registration. Pass null to use null as the key.
    ...
    public static IServiceCollection TryAddKeyedInterceptedScoped<[DynamicallyAccessedMembers(DynamicallyAccessedMemberTypes.PublicConstructors)] TService>(
      ...
      params IInterceptor[] interceptors)
      where TService : class =>
      services.TryAddKeyedIntercepted<TService>(serviceKey, ServiceLifetime.Scoped, interceptors);
    ...
    public static IServiceCollection TryAddKeyedInterceptedScoped<[DynamicallyAccessedMembers(DynamicallyAccessedMemberTypes.PublicConstructors)] TService>(
      ...
      [DynamicallyAccessedMembers(DynamicallyAccessedMemberTypes.PublicConstructors)] params Type[] interceptorTypes)
      where TService : class =>
      services.TryAddKeyedIntercepted<TService>(serviceKey, ServiceLifetime.Scoped, interceptorTypes);
    ...
    public static IServiceCollection TryAddKeyedInterceptedScoped<[DynamicallyAccessedMembers(DynamicallyAccessedMemberTypes.PublicConstructors)] TService, [DynamicallyAccessedMembers(DynamicallyAccessedMemberTypes.PublicConstructors)] TInterceptor>(
      ...
      where TService : class
      where TInterceptor : IInterceptor =>
      services.TryAddKeyedIntercepted<TService, TInterceptor>(serviceKey, ServiceLifetime.Scoped);

    /// <summary>
    /// Attempts to add a keyed scoped service of type <typeparamref name="TService"/> with implementation type
    ...
    /// <returns>The <see cref="IServiceCollection"/> instance with the intercepted keyed scoped service registration added if it was
    /// not already present.</returns>
    public static IServiceCollection TryAddKeyedInterceptedScoped<TService, [DynamicallyAccessedMembers(DynamicallyAccessedMemberTypes.PublicConstructors)] TImplementation>(
      this IServiceCollection services,
      object? serviceKey,
      params IInterceptor[] interceptors)
      where TService : class
      where TImplementation : class, TService =>
      services.TryAddKeyedIntercepted<TService, TImplementation>(serviceKey, ServiceLifetime.Scoped, interceptors);
    ...
    public static IServiceCollection TryAddKeyedInterceptedScoped<TService, [DynamicallyAccessedMembers(DynamicallyAccessedMemberTypes.PublicConstructors)] TImplementation>(
      ...
      where TService : class
      where TImplementation : class, TService =>
      services.TryAddKeyedIntercepted<TService, TImplementation>(serviceKey, ServiceLifetime.Scoped, interceptorTypes);
    ...
    /// <returns>The <see cref="IServiceCollection"/> instance with the intercepted keyed scoped service registration added if it was
    /// not already present.</returns>
    public static IServiceCollection TryAddKeyedInterceptedScoped<TService, [DynamicallyAccessedMembers(DynamicallyAccessedMemberTypes.PublicConstructors)] TImplementation, [DynamicallyAccessedMembers(DynamicallyAccessedMemberTypes.PublicConstructors)] TInterceptor>(
      this IServiceCollection services,
      object? serviceKey)
      where TService : class
      where TImplementation : class, TService
      where TInterceptor : IInterceptor =>
      services.TryAddKeyedIntercepted<TService, TImplementation, TInterceptor>(serviceKey, ServiceLifetime.Scoped);
  }
}
